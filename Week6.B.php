...
<style>
  body{
    background-color:#8FB2A1!important;
  }
  .wrapper .single{
    color:#D0FAC2;
    width:100%;
  ...
  .forecast-block{
  	background-color: #4BA890!important;
  	width:20% !important;
  }
  .title{
...
<?php //Converts to Centigrade function
  function convert2cen($value,$unit){
    if($unit=='C'){
      return $value;
    }else if($unit=='F'){
      $cen = ($value - 32) / 1.8; //converts using this value
      	return round($cen,2);
      }
  }
?>
...
<div class="container wrapper"> <!--container using the bootstrap-->
  <br>
